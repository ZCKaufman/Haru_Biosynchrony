#ifndef _ROS_idmind_tabletop_msgs_ProjectorStatus_h
#define _ROS_idmind_tabletop_msgs_ProjectorStatus_h
...
namespace idmind_tabletop_msgs
{
  ...
  class ProjectorStatus : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "idmind_tabletop_msgs/ProjectorStatus"; };
