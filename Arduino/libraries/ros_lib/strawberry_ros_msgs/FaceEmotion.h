#ifndef _ROS_strawberry_ros_msgs_FaceEmotion_h
#define _ROS_strawberry_ros_msgs_FaceEmotion_h
...
namespace strawberry_ros_msgs
{
  ...
  class FaceEmotion : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "strawberry_ros_msgs/FaceEmotion"; };
