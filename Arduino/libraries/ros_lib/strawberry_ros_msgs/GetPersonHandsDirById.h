#ifndef _ROS_SERVICE_GetPersonHandsDirById_h
#define _ROS_SERVICE_GetPersonHandsDirById_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETPERSONHANDSDIRBYID[] = "strawberry_ros_msgs/GetPersonHandsDirById";

  class GetPersonHandsDirByIdRequest : public ros::Msg
  {
    public:
      typedef uint32_t _person_id_type;
      _person_id_type person_id;

    GetPersonHandsDirByIdRequest():
      person_id(0)
    {
    }
    ...
    virtual const char * getType() override { return GETPERSONHANDSDIRBYID; };
    virtual const char * getMD5() override { return "9266d15c9cca61f2787d9f69171e8f98"; };

  };

  class GetPersonHandsDirByIdResponse : public ros::Msg
  {
    public:
  ...
  class GetPersonHandsDirById {
    public:
    typedef GetPersonHandsDirByIdRequest Request;
    typedef GetPersonHandsDirByIdResponse Response;
  };
