...
ros::Publisher confidence("body_A/confidence", &str_msg);
ros::Publisher oxygen("body_A/oxygen", &str_msg);
ros::Publisher status("body_A/status", &str_msg);
ros::Publisher ext_status("body_A/ext_status", &str_msg);
ros::Publisher r_value("body_A/r_value", &str_msg);
ros::Publisher gsr("body_A/gsr", &str_msg);
