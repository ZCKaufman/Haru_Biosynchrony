#ifndef _ROS_idmind_tabletop_msgs_ProjectorPlaylistCommand_h
#define _ROS_idmind_tabletop_msgs_ProjectorPlaylistCommand_h

#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
#include "idmind_tabletop_msgs/ProjectorCommand.h"

namespace idmind_tabletop_msgs
{

  class ProjectorPlaylistCommand : public ros::Msg
  {
    public:
      uint32_t playlist_length;
      typedef idmind_tabletop_msgs::ProjectorCommand _playlist_type;
      _playlist_type st_playlist;
      _playlist_type * playlist;

    ProjectorPlaylistCommand():
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      if(playlist_lengthT > playlist_length)
        this->playlist = (idmind_tabletop_msgs::ProjectorCommand*)realloc(this->playlist, playlist_lengthT * sizeof(idmind_tabletop_msgs::ProjectorCommand));
      playlist_length = playlist_lengthT;
      for( uint32_t i = 0; i < playlist_length; i++){
      offset += this->st_playlist.deserialize(inbuffer + offset);
        memcpy( &(this->playlist[i]), &(this->st_playlist), sizeof(idmind_tabletop_msgs::ProjectorCommand));
      }
     return offset;
    }

    virtual const char * getType() override { return "idmind_tabletop_msgs/ProjectorPlaylistCommand"; };
    virtual const char * getMD5() override { return "c2e8e1d0bbb36d3480da2f36e07985d3"; };
