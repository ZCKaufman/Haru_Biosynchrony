#ifndef _ROS_SERVICE_GetMotorGains_h
#define _ROS_SERVICE_GetMotorGains_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETMOTORGAINS[] = "idmind_tabletop_msgs/GetMotorGains";

  class GetMotorGainsRequest : public ros::Msg
  {
    public:
      typedef uint8_t _motor_id_type;
      _motor_id_type motor_id;

    GetMotorGainsRequest():
      motor_id(0)
    {
    }
    ...
    virtual const char * getType() override { return GETMOTORGAINS; };
    virtual const char * getMD5() override { return "ad93bb186d2ed1d75ce7e06ce3ebe190"; };

  };

  class GetMotorGainsResponse : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return GETMOTORGAINS; };
    virtual const char * getMD5() override { return "c01604d804b370cc8ae6989532622106"; };

  };

  class GetMotorGains {
    public:
    typedef GetMotorGainsRequest Request;
    typedef GetMotorGainsResponse Response;
  };
