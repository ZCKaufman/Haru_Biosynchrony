#ifndef _ROS_idmind_tabletop_msgs_ProjectorPlaybackCommand_h
#define _ROS_idmind_tabletop_msgs_ProjectorPlaybackCommand_h
...
namespace idmind_tabletop_msgs
{
  ...
  class ProjectorPlaybackCommand : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "idmind_tabletop_msgs/ProjectorPlaybackCommand"; };
