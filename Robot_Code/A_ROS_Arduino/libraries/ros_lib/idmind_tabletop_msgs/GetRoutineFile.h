#ifndef _ROS_SERVICE_GetRoutineFile_h
#define _ROS_SERVICE_GetRoutineFile_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETROUTINEFILE[] = "idmind_tabletop_msgs/GetRoutineFile";

  class GetRoutineFileRequest : public ros::Msg
  {
    public:

    GetRoutineFileRequest()
    {
    }
    ...
    virtual const char * getType() override { return GETROUTINEFILE; };
    virtual const char * getMD5() override { return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class GetRoutineFileResponse : public ros::Msg
  {
    public:
      typedef const char* _routine_file_type;
      _routine_file_type routine_file;

    GetRoutineFileResponse():
      routine_file("")
    {
    }
  ...
  class GetRoutineFile {
    public:
    typedef GetRoutineFileRequest Request;
    typedef GetRoutineFileResponse Response;
  };
