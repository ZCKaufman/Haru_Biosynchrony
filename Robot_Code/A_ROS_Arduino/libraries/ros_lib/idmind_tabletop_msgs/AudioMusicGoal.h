#ifndef _ROS_idmind_tabletop_msgs_AudioMusicGoal_h
#define _ROS_idmind_tabletop_msgs_AudioMusicGoal_h
...
namespace idmind_tabletop_msgs
{
  ...
  class AudioMusicGoal : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "idmind_tabletop_msgs/AudioMusicGoal"; };
