#ifndef _ROS_strawberry_ros_msgs_WaitSpeakingStartsFeedback_h
#define _ROS_strawberry_ros_msgs_WaitSpeakingStartsFeedback_h
...
namespace strawberry_ros_msgs
{
  ...
  class WaitSpeakingStartsFeedback : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "strawberry_ros_msgs/WaitSpeakingStartsFeedback"; };
