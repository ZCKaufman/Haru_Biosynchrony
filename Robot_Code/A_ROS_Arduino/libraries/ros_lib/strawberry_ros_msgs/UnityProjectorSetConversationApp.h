#ifndef _ROS_strawberry_ros_msgs_UnityProjectorSetConversationApp_h
#define _ROS_strawberry_ros_msgs_UnityProjectorSetConversationApp_h
...
namespace strawberry_ros_msgs
{
  ...
  class UnityProjectorSetConversationApp : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "strawberry_ros_msgs/UnityProjectorSetConversationApp"; };
