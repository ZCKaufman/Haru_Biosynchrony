#ifndef _ROS_strawberry_ros_msgs_GetPersonWakeUpWordGoal_h
#define _ROS_strawberry_ros_msgs_GetPersonWakeUpWordGoal_h
...
namespace strawberry_ros_msgs
{
  ...
  class GetPersonWakeUpWordGoal : public ros::Msg
  {
    public:
      typedef float _timeout_type;
      _timeout_type timeout;

    GetPersonWakeUpWordGoal():
      timeout(0)
    {
    }
    ...
    virtual const char * getType() override { return "strawberry_ros_msgs/GetPersonWakeUpWordGoal"; };
