...
namespace strawberry_ros_msgs
{
  ...
  class ASRResult : public ros::Msg
  {
    public:
      ...
      typedef uint32_t _speaker_tag_type;
      _speaker_tag_type speaker_tag;
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 0) = (this->speaker_tag >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (this->speaker_tag >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (this->speaker_tag >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (this->speaker_tag >> (8 * 3)) & 0xFF;
      offset += sizeof(this->speaker_tag);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      offset += length_language_code;
      this->speaker_tag =  ((uint32_t) (*(inbuffer + offset)));
      this->speaker_tag |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      this->speaker_tag |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      this->speaker_tag |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      offset += sizeof(this->speaker_tag);
     return offset;
    }

    virtual const char * getType() override { return "strawberry_ros_msgs/ASRResult"; };
    virtual const char * getMD5() override { return "1f0f83927add8ec51ef3d265c5b28417"; };
