#ifndef _ROS_haru_encouraging_mediator_msgs_RequestImageFeedback_h
#define _ROS_haru_encouraging_mediator_msgs_RequestImageFeedback_h
...
namespace haru_encouraging_mediator_msgs
{
  ...
  class RequestImageFeedback : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "haru_encouraging_mediator_msgs/RequestImageFeedback"; };
