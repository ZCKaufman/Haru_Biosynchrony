#ifndef _ROS_SERVICE_GetPersonIdByName_h
#define _ROS_SERVICE_GetPersonIdByName_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETPERSONIDBYNAME[] = "strawberry_ros_msgs/GetPersonIdByName";

  class GetPersonIdByNameRequest : public ros::Msg
  {
    public:
      typedef const char* _person_name_type;
      _person_name_type person_name;

    GetPersonIdByNameRequest():
      person_name("")
    {
    }
    ...
    virtual const char * getType() override { return GETPERSONIDBYNAME; };
    virtual const char * getMD5() override { return "e2d6bff7c373fbffae616009ee6a2c27"; };

  };

  class GetPersonIdByNameResponse : public ros::Msg
  {
    public:
      typedef uint32_t _person_id_type;
      _person_id_type person_id;

    GetPersonIdByNameResponse():
      person_id(0)
    {
    }
  ...
  class GetPersonIdByName {
    public:
    typedef GetPersonIdByNameRequest Request;
    typedef GetPersonIdByNameResponse Response;
  };
