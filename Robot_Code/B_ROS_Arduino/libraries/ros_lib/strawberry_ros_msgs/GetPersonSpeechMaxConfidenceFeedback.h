#ifndef _ROS_strawberry_ros_msgs_GetPersonSpeechMaxConfidenceFeedback_h
#define _ROS_strawberry_ros_msgs_GetPersonSpeechMaxConfidenceFeedback_h
...
namespace strawberry_ros_msgs
{
  ...
  class GetPersonSpeechMaxConfidenceFeedback : public ros::Msg
  {
    public:
    ...
    GetPersonSpeechMaxConfidenceFeedback():
      person_found(0),
      person_id(0),
      person_name(""),
    ...
    virtual const char * getType() override { return "strawberry_ros_msgs/GetPersonSpeechMaxConfidenceFeedback"; };
