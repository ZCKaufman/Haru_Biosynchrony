#ifndef _ROS_strawberry_ros_msgs_WaitSpeakingStopsResult_h
#define _ROS_strawberry_ros_msgs_WaitSpeakingStopsResult_h
...
namespace strawberry_ros_msgs
{
  ...
  class WaitSpeakingStopsResult : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "strawberry_ros_msgs/WaitSpeakingStopsResult"; };
