#ifndef _ROS_strawberry_ros_msgs_GetPersonSpeechByIdFeedback_h
#define _ROS_strawberry_ros_msgs_GetPersonSpeechByIdFeedback_h
...
namespace strawberry_ros_msgs
{
  ...
  class GetPersonSpeechByIdFeedback : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "strawberry_ros_msgs/GetPersonSpeechByIdFeedback"; };
