#ifndef _ROS_SERVICE_SaveImage_h
#define _ROS_SERVICE_SaveImage_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SAVEIMAGE[] = "idmind_tabletop_msgs/SaveImage";

  class SaveImageRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return SAVEIMAGE; };
    virtual const char * getMD5() override { return "a5d14323998bfef165a952f2540d174e"; };

  };

  class SaveImageResponse : public ros::Msg
  {
    public:
