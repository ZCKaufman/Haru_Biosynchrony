#ifndef _ROS_idmind_tabletop_msgs_TTSGoal_h
#define _ROS_idmind_tabletop_msgs_TTSGoal_h
...
namespace idmind_tabletop_msgs
{
  ...
  class TTSGoal : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "idmind_tabletop_msgs/TTSGoal"; };
