#ifndef _ROS_haru_encouraging_mediator_msgs_KanjiWriteFeedback_h
#define _ROS_haru_encouraging_mediator_msgs_KanjiWriteFeedback_h
...
namespace haru_encouraging_mediator_msgs
{
  ...
  class KanjiWriteFeedback : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "haru_encouraging_mediator_msgs/KanjiWriteFeedback"; };
