#ifndef _ROS_haru_encouraging_mediator_msgs_UserRegistrationFeedback_h
#define _ROS_haru_encouraging_mediator_msgs_UserRegistrationFeedback_h
...
namespace haru_encouraging_mediator_msgs
{
  ...
  class UserRegistrationFeedback : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "haru_encouraging_mediator_msgs/UserRegistrationFeedback"; };
