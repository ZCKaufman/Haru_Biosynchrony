#ifndef _ROS_haru_encouraging_mediator_msgs_SyncPointButtonFeedback_h
#define _ROS_haru_encouraging_mediator_msgs_SyncPointButtonFeedback_h
...
namespace haru_encouraging_mediator_msgs
{
  ...
  class SyncPointButtonFeedback : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "haru_encouraging_mediator_msgs/SyncPointButtonFeedback"; };
