#ifndef _ROS_haru_encouraging_mediator_msgs_QuestionResult_h
#define _ROS_haru_encouraging_mediator_msgs_QuestionResult_h
...
namespace haru_encouraging_mediator_msgs
{
  ...
  class QuestionResult : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "haru_encouraging_mediator_msgs/QuestionResult"; };
